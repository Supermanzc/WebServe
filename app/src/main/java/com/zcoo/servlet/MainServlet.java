...
public class MainServlet extends BaseServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //doGet-----------path1=/storage/emulated/0/WebInfos/app/applist1
        Log.d("MainServlet", "doGet-----------path1=" + path1);
        Log.d("MainServlet", "doGet-----------path2=" + path2);
        Log.d("MainServlet", "doGet-----------path3=" + path3);
